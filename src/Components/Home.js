      ...
      <div className="showBox">
        <div className="mainHeader">
         ...
         <div className="homeContent">
          ...
          <p>Our managing partner Butch Schiellack, CPA, has over 25 years of experience in public accounting and business consulting. He is the current President of the Ventura County Contractors Association and has served as the Director/Officer since 2000.</p>
         </div>
        </div>
